    ...
    public static class CorrelatingMessagesBus
    {
        ...
        public static void Start()
        {
            ...
            do
            {
                ...
                _logger.Info($"Sending ISubmitOrderCorrelated message with correlation id {correlationId}");
                _sendEndpointTask.Result.Send<ISubmitOrderCorrelated>(new
                {
                    OrderId = value,
                    OrderDate = DateTime.Today,
                    OrderAmount = 1,
                    correlationId = correlationId // Don't forget to relay the CorrelationId if you want to get it in the message
                }, context => context.CorrelationId = correlationId); // Don't forget to relay the CorrelationId
                // The ConversationId will be generated by MT
